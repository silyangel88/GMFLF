# coding=utf-8
"""
The Dueling DQNT based on this paper: https://arxiv.org/abs/1511.06581
...
class DuelingDQN:
    def __init__(
        ...
        self.dueling = dueling      # decide to use dueling DQNT or not
